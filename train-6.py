...
def train(
    ...
    weights = '/data3/wangyuhu/weights-yolo/weights-dfm' + os.sep
    ...
    if resume:
        ...
        my_new_model = OrderedDict()
        for k, v in checkpoint['model'].items():
            name = k[7:] # remove 'module.' of dataparallel
            my_new_model[name]=v
        model.load_state_dict(my_new_model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-deform.cfg', help='cfg file path')
